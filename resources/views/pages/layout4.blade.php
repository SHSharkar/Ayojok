...
@section('content')
    ...
    <!-- Kazi Details -->
    <section class="mt-4 mb-4 mt-md-4 mt-lg-4">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5 mb-md-2 mb-lg-2">
    ...
    <section class="page-section pricing mt-3 mb-3" style="background-image: url({{asset($catagorydata->layout_img)}});">
        <div class="container wow fadeIn mt-4 mb-4 mt-sm-4 mb-sm-4 mt-md-5 mb-md-5 mt-lg-5 mb-lg-5">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                            <p class="text-justify">There are some government rule regarding wedding process. Government Charge 1250tk on 100000 tk Denmohor. But after 40000 tk this charge will be 100 tk.</p>

                            <div class="table-responsive">
                                <table style="width:100%; font-size:18px;line-height:1.5;" class="table table-bordered text-center">
                                    <thead>
                                    <tr>
                                        <th>Denmohor Amount</th>
                    ...
                    <p class="text-justify">Kazi collect those TK on behalf of government. They will send this money to government. Usually they don’t have any price rate. If client wants to give him some money happily they will took that.</p>
                </div>
