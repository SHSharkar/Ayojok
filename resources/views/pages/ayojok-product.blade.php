...
@section('content')
    ...
    <!-- Blank section -->
    <section class="page-section services mt-md-4 mt-lg-4">
        <div class="container">
                ...
                <div class="wrapper row">
                    ...
                    <div class="col-lg-6 mb-3">
                        @if (empty($singleproduct->images->count() > 0))
                            <div><img src="http://placehold.it/600x600&text=No+Image+found" alt=""/></div>
                        @else
                            <div id="myCarousel" class="carousel slide service-carousel" data-ride="carousel">
                                <div class="carousel-inner">
                                    @foreach ($singleproduct->images as $image)
                                        <div class="carousel-item">
                                            <img class="d-block w-100" src="{{asset($image->img_location)}}" alt="{{$singleproduct->title}}" id="{{$image->id}}">
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    <div class="details col-lg-6">
                        ...
                        <div class="col-lg-8 @if($agent->isMobile()) mt-2 @endif" style="padding:0;">
                            <div class="form-area">
                                ...
                                <form role="form" id="queryForm">
                                    ...
                                    <div class="form-group">
                                        @guest
                                            <input data-toggle="modal" href="#myModal" type="text" class="form-control" name="phn" placeholder="Mobile Number" required readonly>
                                        @endguest
                                        @auth
                                            <input type="number" class="form-control" name="phn" id="phn" placeholder="Mobile Number" required value="{{Auth::user()->contact}}">
                                        @endauth
                                    </div>
                                    ...
                                    <div class="form-group">
                                        @guest
                                            <textarea data-toggle="modal" href="#myModal" class="form-control" type="textarea" id="message" placeholder="Extra Messages to clarify your need" maxlength="500" rows="3"></textarea>
                                            <span class="help-text"><p id="characterLeft" class="help-block ">You have reached the limit</p></span>
                                        @endguest
                                        @auth
                                            <textarea class="form-control" type="textarea" id="message" placeholder="Extra Messages to clarify your need" maxlength="500" rows="3"></textarea>
                                            <span class="help-text"><p id="characterLeft" class="help-block ">You have reached the limit</p></span>
                                        @endauth
                                    </div>
                                ...
                                <div class="action">
                                    <button type="button" id="submit" class="add-to-cart btn btn-default">Send for query & Get a Call
                                    </button>
                                    <button type="button" id="wishlistbtn" class="like btn text-white btn-default wish-list" onclick="event.preventDefault();document.getElementById('wishlist').submit();">
                ...
                <div class="col-lg-12 product-detail">
                    <div id="exTab2">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#how-to-order" data-toggle="tab">How to order</a>
                            </li>
                        </ul>

                        <div class="tab-content">
                            <div class="tab-pane active" id="description">
                                <p class="text-justify">{{$singleproduct->long_des}}</p>
                            </div>
                            <div class="tab-pane" id="how-to-order">
                                <ul style="padding: 0; margin: 0 0 0 10px; font-size: 16px; line-height: 2rem;">
