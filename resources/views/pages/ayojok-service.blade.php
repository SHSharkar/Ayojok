                                ...
                                <ul class="carousel-indicators">
                                    ...
                                    @foreach ($singleproduct->images as $image)
                                        <li data-target="#myCarousel" data-slide-to="{{$i}}" class="active">
                                            <img src="{{asset($image->img_location)}}" alt="{{$singleproduct->title}}">
                                        </li>
                                        @php
                                            $i++;
                                        @endphp
                        ...
                        <div class="col-lg-8 @if($agent->isMobile()) mt-2 @endif" style="padding:0;">
                            <div class="form-area">
                                ...
                                <form role="form" id="queryForm">
                                    ...
                                    <div class="form-group">
                                        @guest
                                            <input type="text" data-toggle="modal" href="#myModal" class="form-control" name="phn" placeholder="Mobile Number" required readonly>
                                        @endguest
                                        @auth
                                    ...
                                    @guest
                                        <div class="form-group">
                                            <textarea data-toggle="modal" href="#myModal" class="form-control" type="textarea" id="message" placeholder="Extra Messages to clarify your need" maxlength="250" rows="3"></textarea>
                                    ...
                                    @auth
                                        {{-- Extra Message --}}
                                        <div class="form-group">
                                            <textarea class="form-control" type="textarea" id="message" placeholder="Extra Messages to clarify your need" maxlength="250" rows="3"></textarea>
                                            <span class="help-text"><p id="characterLeft" class="help-block ">You have reached
                                            the limit</p></span>
                                        </div>
                                    @endauth
                                ...
                                <div class="action">
                                    ...
                                    <button type="button" id="wishlistbtn" class="btn btn-primary wish-list" onclick="event.preventDefault();document.getElementById('wishlist').submit();">
