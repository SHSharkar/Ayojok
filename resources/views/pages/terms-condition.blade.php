...
<section class="page-section services" style="background-image: url('img/backgrounds/texture-bg.png')">
  <div class="container mt-5 mb-5">
    ...
    <div class="row mt-5 mb-3 text-justify" style="font-weight:400;">
      <p style="font-size:14px;"><em>Please read the following terms and conditions very carefully as your use of service is subject to your acceptance of and compliance with the following terms and conditions (&quot;Terms&quot;). These Terms of Use (“Agreement”) sets forth legally binding terms and conditions and the nature of services offered by www.ayojok.com (hereinafter referred to as “Ayojok” or “Website” or “We” or “us” or “ayojok.com”)and its clients/customers/viewers (hereinafter referred to as “You” or “Your” or “Their”) . The use of this Website (and any other feature, content or application offered from time to time by the Website) is subject at all times to these Terms of Use (and may be modified by us from time to time) and all applicable laws, rules and regulations. We recommend that before accessing and using Ayojok, you must read and agree to these Terms of Use.</em></p>
    </div>

    <div class="row mt-3 mb-5 text-justify" style="font-weight:400;">
      <h5 class="mb-3">1. Acceptance of terms</h5>
      <p style="font-size:14px;">By accessing or using Ayojok in any manner, including visiting or browsing or registering on Ayojok, you agree that you have read, understood and agreed to be legally bound by the terms and conditions set forth below. If you do not agree to be bound by these Terms of Use, please do not access or use this Website. These Terms of Use may be modified, changed or altered by us at any time without prior notice. By agreeing to these Terms of Use, you hereby accept that you shall be responsible for periodically checking the changes and/or updates to these Terms of Use</p>
    </div>

    <div class="row mt-3 mb-5 text-justify" style="font-weight:400;">
      <h5 class="mb-3">2. Use of website</h5>
      <p style="font-size:14px;">Any unauthorized use of and access to the Website is void and prohibited. By accessing and using this Website, you represent and warrant that (a) all registration information submitted by you is truthful and accurate; (b) you agree to maintain the accuracy of the information provided by you; (c) you are above 16 years of age; and (d) the use of the Website by you do not violate any applicable laws or regulations.</p>
    </div>

    <div class="row mt-3 mb-5 text-justify" style="font-weight:400;">
      <h5 class="mb-3">3. Platform for transaction</h5>
      <p style="font-size:14px;">Ayojok is a marketplace to assist you to connect to vendors in respect of all the services and products offered by them for wedding functions, birthdays, corporate events or any other kind of event. You agree and acknowledge that:</p>
