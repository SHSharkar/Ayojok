...
@section('content')
  ...
  <section class="page-section mb-4">
    <div class="container">
      ...
      {!! Form::open(array('route' => 'check2', 'method' => 'POST','id'=>'billing-address'))  !!}
        <div class="row mb-4">
          <div class="col-lg-12">
        ...
        <div class="row mb-5">
          <div class="col-lg-12 ">
            <ul class="pager">
              <li class="previous pull-left"><a href="shop.html"> <i class="fa fa-home"></i> Go to Shop </a></li>
              <li class="next pull-right"> <button type="submit" class="btn btn-primary btn-proceed" name="shippingAddress">Shipping Address <i class="fa fa-arrow-right"></i></button></li>
            </ul>
          </div>
        </div>
        {!! Form::close() !!}
