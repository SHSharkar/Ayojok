                ...
                <div class="col-md-12" style="margin-top:2rem;">
                    ...
                    <div class="box box-primary">
                        <div class="box-body" style="margin-top:2rem;">
                            <form action="{{route('UpdateAdminUser',$data->id)}}" method="post" class="form-horizontal"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select style="padding: 5px;" class="form-control" id="" name="role" required>
                                                ...
                                                <option value="admin" style="text-transform:capitalize;" {{($data->job_title === "admin" )? "selected" : ""}}>admin</option>
                                                <option value="editor" style="text-transform:capitalize;" {{($data->job_title === "editor" )? "selected" : ""}}>editor</option>
                                            </select>
                                        </div>
                                    </div>
                                    <hr>
                                ...
                                <div class="col-md-6">
                                    <div style="margin-top: 20%">
                                        <button class="btn btn-primary " id="submit" type="submit" >Update User Info
                                        </button>
                                    </div>
                                </div>
                            </form>
