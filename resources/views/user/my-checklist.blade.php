...
@section('content')
    ...
    <section class="page-section mb-3">
        <div class="container">
                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">My Checklist</li>
                        </ol>
                    </nav>
            ...
            <?php
            $check = \App\Models\checklist::where('user_id', auth()->id())->count();

            //for showing completed task
            $total_task = $check;
            $completed_task = \App\Models\checklist::where('user_id', auth()->id())->whereStatus(1)->count();
            ...
            <div class="row mb-3">
                <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                    <h4><span id="div1">{{$completed_task}}</span> out of {{$total_task}} Tasks Completed.</h4>

                    <div class="progress" style="background-color: #D8D8D8;">
                        <div class="progress-bar progress-bar-striped active" id="progress_bar" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="74" style="width:<?php echo $percentance.'%'; ?>;text-align: center;background-color: #ea9e1e"></div>
                    </div>

                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#resetChecklist">Reset Checklist</button>

                    <!-- Modal -->
                    <div class="modal fade" id="resetChecklist" tabindex="-1" role="dialog" aria-labelledby="resetChecklistLabel" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="resetChecklistLabel">Reset Checklist</h5>
                                ...
                                <div class="modal-body">
                                    <p>Are you sure?</p>
                                    {!! Form::open(['url' => route('resetChecklist'), 'method' => 'post', 'id' => 'reset-checklist-form']) !!}

                                    {!! Form::close() !!}
                                </div>
                                <div class="modal-footer">
                                    {!! Form::submit('Reset Checklist', ['class' => 'btn btn-danger', 'form' => 'reset-checklist-form']) !!}
