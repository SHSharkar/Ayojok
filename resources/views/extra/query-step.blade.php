      ...
      <div class="modal-body" style="color:white;">
        ...
        <div class="row">
          <div class="col-lg-4 mt-4 text-center " style="padding:0.8rem">
            <img src="{{asset('img\icons\oparator.png')}}" alt="" style="width:8rem;">
          ...
          <div class="col-lg-4 mt-4 text-center " style="padding:0.8rem;">
            <img src="{{asset('img\icons\client-call.png')}}" alt="" style="width:8rem;">
          ...
          <div class="col-lg-4 mt-4 text-center " style="padding:0.8rem;">
            <img src="{{asset('img\icons\offline-book.png')}}" alt="" style="width:8rem;">
