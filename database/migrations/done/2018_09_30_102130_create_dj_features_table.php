...
class CreateDjFeaturesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dj_feature', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('vendor_id');
            $table->integer('feature_1')->default(0);
    ...
    {
        Schema::dropIfExists('dj_features');
    }
}
