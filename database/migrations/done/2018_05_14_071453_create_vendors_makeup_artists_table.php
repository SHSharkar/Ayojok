...
class CreateVendorsMakeupArtistsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vendors_makeup_artist', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
        Schema::dropIfExists('vendors_makeup_artist');
    }
}
