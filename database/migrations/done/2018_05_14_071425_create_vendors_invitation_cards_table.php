...
class CreateVendorsInvitationCardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vendor_invitation_card', function (Blueprint $table) {
          $table->increments('id');
    ...
    {
        Schema::dropIfExists('vendor_invitation_card');
    }
}
