...
class CreateVendorsPhotographyAndCinematographiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vendors_photography', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('vendors_photography');
    }
}
