...
class CreateBridalOutfitFeaturesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bridal_outfit_features', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('bridal_outfit_features');
    }
}
